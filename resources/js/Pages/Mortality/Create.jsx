...
export default function MortalityCreate({ flocks }) {
    ...
    return (
        <AppLayout title="Log Mortality">
            <div className="max-w-lg mx-auto">
                <div className="flex items-center gap-3 mb-5">
                    <Link href="/mortality" className="text-sm text-gray-500">← Back</Link>
                    <h2 className="text-xl font-bold text-gray-800">📉 Log Mortality</h2>
                </div>
                <form onSubmit={submit} className="space-y-4 bg-white rounded-xl border border-gray-100 p-4">
                    ...
                    <button type="submit" disabled={processing}
                        className="w-full bg-red-600 text-white font-semibold py-3 rounded-xl hover:bg-red-700 disabled:opacity-50">
